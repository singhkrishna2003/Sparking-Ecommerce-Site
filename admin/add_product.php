            ...
            <div class="table-responsive">
                <form id="create-form" method="POST" action="create_product.php" enctype="multipart/form-data">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea class="form-control" id="product-desc" rows="3" name="description" placeholder="Description" required></textarea>
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" class="form-control" id="product-special-offer" name="offer" placeholder="Sale%" required />
                    </div>
                    <div class="form-group mt-2">
