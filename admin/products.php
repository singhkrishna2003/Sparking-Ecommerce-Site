  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php if (isset($_GET['edit_success_message'])) { ?>
        <p style="color: green;" class="text-center"><?php echo $_GET['edit_success_message']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['edit_failure_message'])) { ?>
        <p style="color: red;" class="text-center"><?php echo $_GET['edit_failure_message']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['product_created'])) { ?>
        <p style="color: green;" class="text-center"><?php echo $_GET['product_created']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['product_failed'])) { ?>
        <p style="color: red;" class="text-center"><?php echo $_GET['product_failed']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['deleted_success_message'])) { ?>
        <p style="color: green;" class="text-center"><?php echo $_GET['deleted_success_message']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['deleted_failure_message'])) { ?>
        <p style="color: red;" class="text-center"><?php echo $_GET['deleted_failure_message']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['images_updated'])) { ?>
        <p style="color: green;" class="text-center"><?php echo $_GET['images_updated']; ?></p>
      <?php } ?>

      <?php if (isset($_GET['images_failed'])) { ?>
        <p style="color: red;" class="text-center"><?php echo $_GET['images_failed']; ?></p>
      <?php } ?>
