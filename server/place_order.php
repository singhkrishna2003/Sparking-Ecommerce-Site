...
if (!isset($_SESSION['logged_in'])) { //if user is not logged in
    ...
    if (isset($_POST['place_order'])) {
        ...
        //2. issue new order and store order information in the database
        ...
        foreach ($_SESSION['cart'] as $key => $value) {
            ...
            $product = $_SESSION['cart'][$key]; // Array of product
        ...
        //5. remove everythin from cart --> delay until payment is done
        // unset($_SESSION['cart']);
